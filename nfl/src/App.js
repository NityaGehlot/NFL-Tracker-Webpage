...
const PageOne = () => <div className="content"><h2>Page One Content</h2></div>;
const PageTwo = () => <div className="content"><h2>Page Two Content</h2></div>;
        ...
        <Router>
            <div className="app">
                ...
                <nav className="navbar">
                    <Link to="/page1" className="nav-item"><span>Section 1</span></Link>
                    <Link to="/page2" className="nav-item"><span>Section 2</span></Link>
